...
if (isset($_GET['mensagem']) && $_GET['mensagem'] == 1):?>
      ...
      <input class="input-contato" type="text" id="nome" name="nome" value="<?= $_SESSION['nome_usuario'] ?>" required
        readonly>

      <label class="label-contato" for="email">Seu Email</label>
      <input class="input-contato" type="email" id="email" name="email" value="<?= $_SESSION['email_usuario'] ?>"
        required readonly>
