  ...
  <section class="section-account">
    <form class="form-account" action="conteudos/cadastrar/cadastrar.php" method="post">
      ...
      <div class="group-input">
        <input class="input-account" type="text" name="usuario" id="usuario" placeholder="Nome de usuário" required>
      </div>
      <div class="group-input">
        <input class="input-account" type="email" name="email" id="email" placeholder="E-mail" required>
      </div>
      <div class="group-input">
        <input class="input-account" type="password" name="senha" id="senha" placeholder="Senha" required>
      </div>
      <div class="group-input">
        <input class="input-account" type="password" name="confirmar_senha" id="confirmar_senha"
          placeholder="Confirme a senha" required>
      </div>
      <button class="buttom-account" type="submit">CADASTRAR</button>
